package com.project.fullstack.grpc;
...
public class BillingServiceGrpcClient {
    ...
    public BillingResponse createBillingAccount(UUID patientId, String name, String email){
        BillingRequest request = BillingRequest.newBuilder().setPatientId(String.valueOf(patientId)).setName(name).setEmail(email).build();
